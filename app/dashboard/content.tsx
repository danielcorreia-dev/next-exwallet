...
import { Minus, Plus, Wallet2 } from 'lucide-react';
const DashboardContent = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="flex flex-col md:flex-row md:gap-5 justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8">
          <Card className="w-full mt-5 py-4 px-8">
            <CardHeader>
              <Minus size={24} />
              <CardDescription className="py-3 text-lg md:text-xl">
                Débito Disponível
              </CardDescription>
      ...
      <table className="m-auto flex flex-col justify-center align-middle w-full">
        <tbody className="m-auto">
          {invoices.map((invoice) => (
            <TableRow key={invoice.id}>
              <TableCell className="w-[400px] font-medium">
                {invoice.nameOfTransaction}
              </TableCell>
